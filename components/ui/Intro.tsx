export default function Intro() {
  return (
    <div className="2xl:h-full max-2xl:w-full 2xl:w-[700px] z-10 text-paper flex 2xl:flex-col 2xl:justify-end 2xl:sticky 2xl:top-0 ">
      <div className="flex flex-col font-raleway max-2xl:mt-16 mx-8 mb-12 2xl:mb-32 2xl:mx-24 ">
        ...
        <div className="font-normal text-lg mb-6">IIT Roorkee 2024 Grauate</div>
